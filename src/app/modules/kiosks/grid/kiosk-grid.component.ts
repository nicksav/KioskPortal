...
@Component({
  ...
  styleUrls: ['./kiosk-grid.component.css']
})
export class KioskGridComponent extends BaseComponent implements OnInit {
  ...
  constructor(private _api: ApiService,
    ...
    this._observer.kiosk$.subscribe((role) => {
  ...
  private _loadItems(params = this.search) {
    ...
    this._api.kiosk.getList(params)
      ...
      .subscribe((res) => {
        ...
        this.kiosks = data.map(function (role) {
          return role;
        });
